...
ln -s /usr/lib/systemd/system/motd-trigger.service %{buildroot}/usr/lib/systemd/system/multi-user.target.wants/motd-trigger.service
...
/usr/lib/systemd/system/multi-user.target.wants/motd-trigger.service
